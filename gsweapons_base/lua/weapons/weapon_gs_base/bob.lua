...
local cl_bobcycle = CreateConVar( "cl_cs_bobcycle", "0.8", FCVAR_CHEAT )
local cl_bobup = CreateConVar( "cl_cs_bobup", "0.5", FCVAR_CHEAT )
local cl_bobspeed = CreateConVar( "cl_cs_bobspeed", "320", FCVAR_CHEAT )
...
local cl_bobcycle = CreateConVar( "cl_hl_bobcycle", "0.45", FCVAR_CHEAT )
local cl_bobup = CreateConVar( "cl_hl_bobup", "0.5", FCVAR_CHEAT )
local cl_bobspeed = CreateConVar( "cl_hl_bobspeed", "320", FCVAR_CHEAT )

AddBobbingMethod( "hl", function( pWeapon, vOrigin, ang )
	local pPlayer = pWeapon:GetOwner()
